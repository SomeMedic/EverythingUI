...
import { SparkleButtonContainer, StyledSparkleButton, Text, SparkSVG, ParticlePen, Particle } from './styles';
import { BaseComponentProps } from '../../types';

export interface SparkleButtonProps extends BaseComponentProps {
  text?: string;
  onClick?: () => void;
}
...
export const SparkleButton: React.FC<SparkleButtonProps> = ({ 
  ...
  const particles = Array.from({ length: 15 }, () => ({
    ...
    size: getRandomValue(0.1, 0.5),
    duration: getRandomValue(0.5, 1.5),
    delay: getRandomValue(0, 0.5),
    originX: getRandomValue(500, 1500),
    originY: getRandomValue(500, 1500),
  }));

  return (
    <SparkleButtonContainer className={className}>
      <StyledSparkleButton onClick={onClick} {...props}>
        <span className="spark"></span>
        <span className="backdrop"></span>
        <SparkSVG viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
